...
The `AI Deep SAST` maintainers take all security issues in the project
seriously. Thank you for improving the security of `AI Deep SAST`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`AI Deep SAST` leverages GitHub's private vulnerability reporting.
